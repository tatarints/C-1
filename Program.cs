...
namespace lesson_3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //3
            //char[] chars = { 'o', 'l', 'l', 'e', 'H' };

            //int c = chars.Length; // длина массива
            ...
            //    lastIndex = chars[i];
            //    chars[i] = chars[c - i - 1];
            //    chars[c - i - 1] = lastIndex;
            //}
            //foreach (int i in chars)
            //{
            //        Console.Write(i);
            //}
            //Программу написала, но смогла вывести только числовые значения, а как переходить к буквам не допонимаю.
